...
| <a id="gen-ai-evaluation-input-metadata" href="#gen-ai-evaluation-input-metadata">`gen_ai.evaluation.input.metadata`</a> | string | Metadata associated with the evaluation input. [13] | `{"evaluator_model": "gpt-4o", "max_tokens": 42}` | ![Development](https://img.shields.io/badge/-development-blue) |
