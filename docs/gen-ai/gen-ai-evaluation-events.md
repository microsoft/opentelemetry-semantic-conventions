...
| [`gen_ai.evaluation.input.metadata`](/docs/attributes-registry/gen-ai.md) | any | Metadata associated with the evaluation input. [2] | `{\"requestId\": \"fab3ee5d-a3c6-4c47-b3de-901bf02fa045\"}` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.evaluation.output.metadata`](/docs/attributes-registry/gen-ai.md) | any | Metadata associated with the evaluation result. [3] | `{\"Perplexity\": 1.335}` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
